                        ...
                        for (i = 0; i < responseSplit.length - 1; i++) {
		                   ...
		                   <div class="my-list">
		                    ...
		                    <h3>Store ID:  `+ storeId+`</h3 >
                                ...
                                + "<p></p><a href=\"" + baseUrl + "/Store?storeId=" + storeId + "\" class=\"block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1\" >Manage Staff</a>"
